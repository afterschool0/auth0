...
router.get("/common/chat_dialog", [exception.page_catch, (request: any, response: any): void => {
    response.render("systems/common/chat_dialog", {config: config, message: message});
}]);
